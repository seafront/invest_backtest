...
const STRATEGY_DETAILS: Record<string, {
  ...
  buy_and_hold: {
    how_it_works:
      "가장 단순한 투자 전략입니다. 첫 날 매수한 후 시뮬레이션 종료 시점까지 보유합니다.\n\n" +
      "거치식 모드: 초기 자본금으로 첫 날 전액 매수 → 끝까지 보유\n" +
      "적립식(DCA) 모드: 매월 정해진 금액으로 매수 → 끝까지 보유 (매도 없음)\n\n" +
      "모든 다른 전략의 벤치마크로 사용됩니다. " +
      "어떤 전략이든 Buy & Hold보다 나은 성과를 내야 의미가 있습니다.\n\n" +
      "워렌 버핏: \"내가 가장 좋아하는 보유 기간은 영원이다.\"",
    buy_rule:
      "거치식: 첫 거래일에 전액 매수\n" +
      "적립식: 매월 첫 거래일에 정해진 금액만큼 매수\n\n" +
      "• 파라미터 없음 — 타이밍 판단 불필요\n" +
      "• 시장 상황과 무관하게 무조건 매수",
    sell_rule:
      "매도 없음\n\n" +
      ...
      "• 거래 비용/세금 = 0 (최초 매수 제외)",
    strengths: [
      "가장 단순 — 감정 개입 없음, 실수 여지 없음",
      "거래 비용 최소 (매수 1회, 매도 0회)",
      "세금 이연 효과 — 매도를 안 하므로 양도세 발생 안 함",
      "장기적으로 대부분의 액티브 전략을 이김 (S&P 500 기준)",
    ],
    weaknesses: [
      "하락장을 그대로 맞음 — MDD를 100% 감수해야 함",
      "2008년 금융위기 (-50%), 2022년 하락장 (-30%) 등 큰 손실 구간 존재",
      "레버리지 ETF에서는 변동성 손실(Volatility Decay)로 장기 성과 저하 가능",
      "시장이 장기 횡보하면 기회비용 발생",
    ],
    best_for: "장기 투자 (10년+), 시장 지수 ETF (SPY, QQQ), 인덱스 펀드. 다른 전략의 벤치마크로 필수",
  },
  ma_crossover: {
    how_it_works:
